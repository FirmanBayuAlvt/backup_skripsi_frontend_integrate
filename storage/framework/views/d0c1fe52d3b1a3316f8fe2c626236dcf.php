...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - TernakPark</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 sidebar-gradient text-white flex flex-col shadow-2xl">
            <div class="p-5 border-b border-white/20">
                <div class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('images/logo TernakPark Wonosalam.png')); ?>" alt="TernakPark" class="h-10 w-auto">
                    <div>
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('dashboard') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-chart-pie w-5 text-center"></i><span class="text-sm font-medium">Dashboard</span>
                </a>
                <a href="<?php echo e(route('livestocks.index')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('livestocks.*') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-cow w-5 text-center"></i><span class="text-sm font-medium">Ternak</span>
                </a>
                <a href="<?php echo e(route('pens.index')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('pens.*') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-warehouse w-5 text-center"></i><span class="text-sm font-medium">Kandang</span>
                </a>
                <a href="<?php echo e(route('feeds.index')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('feeds.*') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-seedling w-5 text-center"></i><span class="text-sm font-medium">Pakan</span>
                </a>
                <a href="<?php echo e(route('predictions.index')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('predictions.*') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-brain w-5 text-center"></i><span class="text-sm font-medium">Prediksi</span>
                </a>
                <a href="<?php echo e(route('reports.index')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('reports.*') ? 'sidebar-item-active' : ''); ?>">
            ...
            <div class="p-3 border-t border-white/20">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold truncate"><?php echo e(session('user')['name'] ?? 'Admin'); ?></p>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50">
            ...
            <header class="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center sticky top-0 z-10 shadow-sm">
                <h1 class="text-2xl font-semibold text-gray-800"><?php echo $__env->yieldContent('header-title', 'Dashboard'); ?></h1>
...
<?php /**PATH D:\Tugas Akhir\Aplikasi_TernakParkWonosalam\ternakpark-frontend\resources\views/layouts/app.blade.php ENDPATH**/ ?>