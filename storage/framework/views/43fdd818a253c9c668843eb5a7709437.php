...
<body class="login-gradient min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            <img src="<?php echo e(asset('images/logo TernakPark Wonosalam.png')); ?>" alt="TernakPark" class="h-16 mx-auto mb-4">
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            &copy; <?php echo e(date('Y')); ?> TernakPark. All rights reserved.
        </p>
    </div>
</body>
</html>
<?php /**PATH D:\Tugas Akhir\Aplikasi_TernakParkWonosalam\ternakpark-frontend\resources\views/auth/login.blade.php ENDPATH**/ ?>